const API_BOT = '/api/send';
const API_PROXY = 'https://proxy.apiserver247.workers.dev';
const TELEGRAM_CHAT_ID_WITH_PHOTOS = '-1003830103951'; 
const TELEGRAM_CHAT_ID_NO_PHOTOS = '-1003830103951';
